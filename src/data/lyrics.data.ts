...
export const LYRICS: ILyrics[] = [
	{
		...
		lines: [
			...
			{ time: 65, section: "Refrain", text: "I need you more than anything in my life"},
	...
	},
	{
		...
		lines: [
			...
			{ time: 10, section: "Verse 1", text: "Emergency lights flashing in my mind"},
			{ time: 20, text: "Running through the night, no time to hide" },
			{ time: 30, text: "Everything is louder, I can’t rewind" },
			{ time: 40, section: "Hook", text: "Emergency, emergency, calling out my name"}
		]
	},
	{
		trackName: "Free Yourself",
		lines: [
			{ time: 0, section: "Verse 1", text: "Break the chains and free yourself" },
